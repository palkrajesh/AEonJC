...
public class AcornApplet extends javacard.framework.Applet
{
    ...
    private   AcornCore  myacorn = null;           //ACORN engine
        ...
        if (apduBuffer[ISO7816.OFFSET_CLA] == CLA_SIMPLEAPPLET) {
            switch ( apduBuffer[ISO7816.OFFSET_INS] )
            {
                ...
                case INS_PERF_SETSTOP:
                    PM.m_perfStop = Util.makeShort(apduBuffer[ISO7816.OFFSET_CDATA], apduBuffer[(short) (ISO7816.OFFSET_CDATA + 1)]);
                    break;
    ...
    public void ACORNEncryption(APDU apdu){
        ...
        myacorn.AcornCoreInitialization(m_ramArrayCt, (short)0, m_ramArrayPt, dataLen, AD, ADLEN, NSEC, NPUB, KEY, KEYLEN);
        // ACORN Encryption
        myacorn.crypto_aead_encrypt();
    ...
    public void ACORNDecryption(APDU apdu){
        ...
        myacorn.AcornCoreInitialization(m_ramArrayCt, dataLen, m_ramArrayPt, (short)0, AD1, ADLEN1, NSEC1, NPUB1, KEY1, KEYLEN1);
        // ACORN Decryption
        myacorn.crypto_aead_decrypt();
