...
public class MorusApplet extends javacard.framework.Applet
{
    ...
    public void MORUSEncryption(APDU apdu){
        ...
        mymorus.MorusCoreInitialization(m_ramArray, (short)0, m_ramArray, dataLen, AD, ADLEN, NSEC, NPUB, KEY);
    ...
    public void MORUSDecryption(APDU apdu){
        ...
        mymorus.MorusCoreInitialization(m_ramArray, dataLen, m_ramArray, (short)0, AD1, ADLEN1, NSEC1, NPUB1, KEY1);
        // MORUS Decryption
