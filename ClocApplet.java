...
public class ClocApplet extends javacard.framework.Applet
{
    ...
    public void CLOCEncryption(APDU apdu){
        ...
        mycloc.ClocCoreInitialization(m_ramArrayCt, (short)0, m_ramArrayPt, dataLen, AD, ADLEN, NSEC, NPUB, KEY, KEYLEN);
        // CLOC Encryption
        mycloc.crypto_aead_encrypt();
    ...
    public void CLOCDecryption(APDU apdu){
        ...
        mycloc.ClocCoreInitialization(m_ramArrayCt, dataLen, m_ramArrayPt, (short)0, AD1, ADLEN1, NSEC1, NPUB1, KEY1, KEYLEN1);
        // CLOC Decryption
        mycloc.crypto_aead_decrypt();
